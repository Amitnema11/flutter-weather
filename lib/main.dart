        ...
        home: Scaffold(
            ...
            body: Column(
              ...
              children: [
                ...
                Text("Temperature - ${weatherModel?.main?.temp}K"),
                Text("Min Temperature - ${weatherModel?.main?.tempMin}K"),
                Text("Max Temperature - ${weatherModel?.main?.tempMax}K"),
                Text("Weather - ${weatherModel?.weather?[0].main}"),
                Text("Description - ${weatherModel?.weather?[0].description}"),
                Text("Wind speed - ${weatherModel?.wind?.speed}m/s"),
